    ...
    <div class="glide w-full h-[300px] md:h-[500px] lg:h-[600px] rounded-lg">
        <div class="glide__track w-full h-[300px] md:h-[500px] lg:h-[600px]" data-glide-el="track">
            <ul class="glide__slides w-full h-[300px] md:h-[500px] lg:h-[600px]">
                <li class="glide__slide"><img class="w-full h-full object-cover" src="{{ asset('banner/1.jpeg') }}"
                        alt="Image 1"></li>
                <li class="glide__slide"><img class="w-full h-full object-cover" src="{{ asset('banner/2.jpeg') }}" alt="Image 2"></li>
                <li class="glide__slide"><img class="w-full h-full object-cover"
                        src="{{ asset('banner/3.jpeg') }}"
                        alt="Image 3"></li>
                            ...
                            <div class="flex">
                                @if ($barang->stock > 0)
                                    <form action="/cart/{{ $barang->id }}" method="POST">
                                        ...
                                        <button type="submit"
                                            class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-500">Add
                                            to Cart
