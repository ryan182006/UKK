                    ...
                    <div class="p-4">
                        ...
                        <div class="flex">
                            ...
                            <a href="/cart" class="mx-3">
                                <button class="bg-blue-600 text-white px-4 py-2  rounded-md hover:bg-blue-500 ">Add chart
                                    <span
                                        class="inline-flex items-center justify-center w-3 h-1 p-3 ml-1 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">{{ $jumlah }}</span>
